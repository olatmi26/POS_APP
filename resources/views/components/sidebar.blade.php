        ...
        <div class="main-menu">
            <ul class="side-menu list-unstyled" id="side-main-menu">
              ...
              @if($category_permission_active || $index_permission_active || $print_barcode_active || $stock_count_active || $adjustment_active)
                  ...
                  @if($index_permission_active)
                        <li id="product-list-menu">
                            <a href="{{route('products.index')}}">
                                {{__('file.product_list')}}
                            </a>
                        </li>
                        <?php 
                    $add_permission = DB::table('permissions')->
                        where('name', 'products-add')->first();
                ...
                where('name', 'purchases-index')->first();
                  $index_permission_active = DB::table('role_has_permissions')->where([
                        ['permission_id', $index_permission->id],
                        ['role_id', $role->id]
                    ])->first();
              ...
              @if($index_permission_active)
                <li>
                    <a aria-expanded="false" data-toggle="collapse" href="#purchase">
                    ...
                    <ul class="collapse list-unstyled " id="purchase">
                        <li id="purchase-list-menu">
                            <a href="{{route('purchases.index')}}">
                                {{trans('file.Purchase List')}}
                            </a>
                        </li>
                        <?php 
                    $add_permission = DB::table('permissions')->
                        where('name', 'purchases-add')->first();
                    $add_permission_active = DB::table('role_has_permissions')->where([
                        ['permission_id', $add_permission->id],
                        ['role_id', $role->id]
                    ])->first();
              ...
              @if($sale_index_permission_active || $gift_card_permission_active || $coupon_permission_active || $delivery_permission_active)
                <li>
                    <a aria-expanded="false" data-toggle="collapse" href="#sale">
                    ...
                    <ul class="collapse list-unstyled " id="sale">
                        ...
                        <li id="sale-list-menu">
                            <a href="{{route('sales.index')}}">
                                {{trans('file.Sale List')}}
                            </a>
                        </li>
                        @if($sale_add_permission_active)
                        <li>
                            <a href="{{route('sale.pos')}}">
                                POS
                            </a>
                        </li>
                  ...
                  @if($gift_card_permission_active)
                        <li id="gift-card-menu">
                            <a href="{{route('gift_cards.index')}}">
                                {{trans('file.Gift Card List')}}
                            </a>
                        </li>
                        @endif
                ...
                <?php 
                $index_permission = DB::table('permissions')->
                where('name', 'expenses-index')->first();
                $index_permission_active = DB::table('role_has_permissions')->where([
                        ['permission_id', $index_permission->id],
                        ['role_id', $role->id]
                    ])->first();
              ...
              @if($index_permission_active)
                <li>
                    <a aria-expanded="false" data-toggle="collapse" href="#expense">
                    ...
                    <ul class="collapse list-unstyled " id="expense">
                        <li id="exp-cat-menu">
                            <a href="{{route('expense_categories.index')}}">
                                {{trans('file.Expense Category')}}
                            </a>
                        </li>
                        <li id="exp-list-menu">
                            <a href="{{route('expenses.index')}}">
                                {{trans('file.Expense List')}}
                            </a>
                        </li>
                        <?php 
                    $add_permission = DB::table('permissions')->
                        where('name', 'expenses-add')->first();
                    $add_permission_active = DB::table('role_has_permissions')->where([
                        ['permission_id', $add_permission->id],
                        ['role_id', $role->id]
                    ])->first();
              ...
              @if($index_permission_active)
                <li>
                    <a aria-expanded="false" data-toggle="collapse" href="#quotation">
                    ...
                    <ul class="collapse list-unstyled " id="quotation">
                ...
                <?php 
                $index_permission = DB::table('permissions')->
                where('name', 'transfers-index')->first();
                $index_permission_active = DB::table('role_has_permissions')->where([
                        ['permission_id', $index_permission->id],
                        ['role_id', $role->id]
                    ])->first();
              ...
              @if($index_permission_active)
                <li>
                    <a aria-expanded="false" data-toggle="collapse" href="#transfer">
                    ...
                    <ul class="collapse list-unstyled " id="transfer">
                        <li id="transfer-list-menu">
                            <a href="{{route('transfers.index')}}">
                                {{trans('file.Transfer List')}}
                            </a>
                        </li>
                        <?php 
                    $add_permission = DB::table('permissions')->
                        where('name', 'transfers-add')->first();
                    $add_permission_active = DB::table('role_has_permissions')->where([
                        ['permission_id', $add_permission->id],
                        ['role_id', $role->id]
                    ])->first();
                ...
                where('name', 'returns-index')->first();
              ...
              @if($sale_return_index_permission_active || $purchase_return_index_permission_active)
                <li>
                    <a aria-expanded="false" data-toggle="collapse" href="#return">
                    ...
                    <ul class="collapse list-unstyled " id="return">
                ...
                <?php 
                $index_permission = DB::table('permissions')->
                where('name', 'account-index')->first();
                $index_permission_active = DB::table('role_has_permissions')->where([
                        ['permission_id', $index_permission->id],
                        ['role_id', $role->id]
                    ])->first();
              ...
              @if($index_permission_active || $balance_sheet_permission_active || $account_statement_permission_active || $money_transfer_permission_active)
                <li class="">
                    <a aria-expanded="false" data-toggle="collapse" href="#account">
                    ...
                    <ul class="collapse list-unstyled " id="account">
                        ...
                        <li id="account-list-menu">
                            <a href="{{route('accounts.index')}}">
                                {{trans('file.Account List')}}
                            </a>
                        </li>
                        <li>
                            <a href="" id="add-account">
              ...
              @if(Auth::user()->role_id != 5)
                <li class="">
                    <a aria-expanded="false" data-toggle="collapse" href="#hrm">
                    ...
                    <ul class="collapse list-unstyled " id="hrm">
              ...
              @if($user_index_permission_active || $customer_index_permission_active || $biller_index_permission_active || $supplier_index_permission_active)
                <li>
                    <a aria-expanded="false" data-toggle="collapse" href="#people">
                    ...
                    <ul class="collapse list-unstyled " id="people">
                        @if($user_index_permission_active)
                        <li id="user-list-menu">
                            <a href="{{route('user.index')}}">
                                {{trans('file.User List')}}
                            </a>
                        </li>
                  ...
                  @if($customer_index_permission_active)
                    ...
                    $customer_add_permission = DB::table('permissions')->
                        where('name', 'customers-add')->first();
                  ...
                  @if($supplier_index_permission_active)
                    ...
                    $supplier_add_permission = DB::table('permissions')->
                        where('name', 'suppliers-add')->first();
              ...
              @if($profit_loss_active || $best_seller_active || $warehouse_report_active || $warehouse_stock_report_active || $product_report_active || $daily_sale_active || $monthly_sale_active || $daily_purchase_active || $monthly_purchase_active || $purchase_report_active || $sale_report_active || $payment_report_active || $product_qty_alert_active || $user_report_active || $customer_report_active || $supplier_report_active || $due_report_active)
                <li>
                    <a aria-expanded="false" data-toggle="collapse" href="#report">
                    ...
                    <ul class="collapse list-unstyled " id="report">
                        ...
                        <li id="profit-loss-report-menu">
                            ...
                            <input name="start_date" type="hidden" value="{{date('Y-m').'-'.'01'}}"/>
                            <input name="end_date" type="hidden" value="{{date('Y-m-d')}}"/>
                            <a href="" id="profitLoss-link">
                  ...
                  @if($best_seller_active)
                        <li id="best-seller-report-menu">
                            <a href="{{url('report/best_seller')}}">
                                {{trans('file.Best Seller')}}
                            </a>
                        </li>
                        @endif
                  @if($product_report_active)
                        <li id="product-report-menu">
                            ...
                            <input name="start_date" type="hidden" value="{{date('Y-m').'-'.'01'}}"/>
                            <input name="end_date" type="hidden" value="{{date('Y-m-d')}}"/>
                            <input name="warehouse_id" type="hidden" value="0"/>
                  ...
                  @if($purchase_report_active)
                        <li id="purchase-report-menu">
                            ...
                            <input name="end_date" type="hidden" value="{{date('Y-m-d')}}"/>
                            <input name="warehouse_id" type="hidden" value="0"/>
                            <a href="" id="purchase-report-link">
                  ...
                  @if($warehouse_report_active)
                        <li id="warehouse-report-menu">
                            <a href="" id="warehouse-report-link">
                  ...
                  @if($customer_report_active)
                        <li id="customer-report-menu">
                            <a href="" id="customer-report-link">
                  ...
                  @if($supplier_report_active)
                        <li id="supplier-report-menu">
                            <a href="" id="supplier-report-link">
                ...
                @endif
                <li>
                    <a aria-expanded="false" data-toggle="collapse" href="#setting">
                    ...
                    <ul class="collapse list-unstyled " id="setting">
                      ...
                      $send_notification_permission = DB::table('permissions')->
                        where('name', 'send_notification')->first();
                  ...
                  @if($role->id <= 2)
                        <li id="role-menu">
                            <a href="{{route('role.index')}}">
                                {{trans('file.Role Permission')}}
                            </a>
                        </li>
                        @endif
                  @if($send_notification_permission_active)
                        <li id="notification-menu">
                            <a href="" id="send-notification">
